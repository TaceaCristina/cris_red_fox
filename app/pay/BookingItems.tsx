    ...
    <div className="booking-items">
      <header className="mb-6">
        <Button variant="secondary" onClick={() => router.back()}>
          <HiMiniChevronDoubleLeft size={20} /> Înapoi
        </Button>
      </header>
        ...
        <Table className="w-full border-collapse ">
          <TableHeader>
            <TableRow className=" text-xs ">
              <TableHead className="p-2 text-center font-bold">Data</TableHead>
              ...
              <TableHead className="p-2 text-center font-bold">Ședințe</TableHead>
              <TableHead className="p-2 text-center font-bold">
                Șterge
              </TableHead>
            </TableRow>
